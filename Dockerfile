...
WORKDIR /home/${USER_APP}/nim

COPY ./requirements.txt /home/${USER_APP}/nim/requirements.txt


RUN pip install -r /home/${USER_APP}/nim/requirements.txt

COPY . .

RUN chown -R ${USER_APP}:${USER_APP} /home/${USER_APP}/nim 
